...
Если в процессе оплаты вы получили код ошибки 40 - это значит что счёт уже оплачен, а код ошибки 33 говорит о том, что время оплаты истекло.';

$string['checkinvoice'] = 'Делать проверку invoice';
$string['checkinvoice_help'] = 'Эта опция включает дополнительную проверку инвойса в Робокассе при создании и получении платежа.
При создании проверяется что такой платёж ещё не существует.
А при получении подтверждения от банка делается запрос на проверку факта оплаты выставленного счёта.';
